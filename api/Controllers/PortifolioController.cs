...
namespace api.Controllers
{
    ...
    public class PortifolioController : ControllerBase
    {
        ...
        IStockRepository stockRepo, IPortifolioRepository portifolioRepo, IFMPService fmpService)
        {
        ...
        public async Task<IActionResult> GetUserPortifolio()
        {
            ...
            var userPortfolio = await _portifolioRepo.GetUserPortifolio(appUser);
        ...
        public async Task<IActionResult> AddPortfolio(string symbol)
        {
            ...
            await _portifolioRepo.CreateAsync(portfolioModel);
        ...
        public async Task<IActionResult> DeletePortfolio(string symbol)
        {
            ...
            {
                await _portifolioRepo.DeletePortifolio(appUser, symbol);
            }
            else
            {
